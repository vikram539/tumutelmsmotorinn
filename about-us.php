...
<section class="first-section">
	...
	<div class="container">
		...
		$indexpageID=1;
			...
			@$about_h2=$fun_obj->TextArray($indexpageID, "heading");	

			@$about_p=$fun_obj->TextArray($indexpageID, "p");
		...
		?>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				...
				<div class="first-section-content inner-content">					
					...
					<?php if($about_h2[0]!='') echo"<h2 data-content='".$about_h2[0]."'></h2>";?>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-7">
				...
				<div class="read-more-content">
					...
					<?php 
						...
						for($i=1; $i<count($about_p); $i++)

						{

							if($about_p[$i]!='') echo"<p>".$about_p[$i]."</p>";	
